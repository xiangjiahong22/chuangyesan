var PImgPlayer = {   
        ...
        init : function( objID, w, h, time ){
                ...
                this._container.style.border = "1px solid #d0d0d0";   
                ...
                //   
                var baseSpacStyle = "clear:both; display:block; width:23px;line-height:14px; font-size:12px; FONT-FAMILY:'����';opacity: 0.6;";   
