...
function makeSelectBox(thisId, imgsrc) {
    var downArrowSrc = imgsrc + "09/img/down.gif";
    ...
    newSelect += "    </tr>";
    newSelect += "</table>";
    newSelect += "<table cellpadding='0' cellspacing='1' border='0' bgcolor='#dbdfe6' onClick=\"viewOptionLayer('"+ objId + "')\" style='cursor:hand;'>";
    newSelect += "    <tr>";
